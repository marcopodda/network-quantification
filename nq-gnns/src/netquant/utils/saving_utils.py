...
def save_predictions(
    ...
    DataLoader | list[DataLoader], so `Trainer.predict` method can return
    ...
    if output_format not in ("json", "csv"):
        raise NotImplementedError(
            ...
            "Or change `netquant.utils.saving.save_predictions` func logic."
        )
    ...
    raise Exception(
        ...
        "Or change `netquant.utils.saving.save_predictions` function logic."
    )
